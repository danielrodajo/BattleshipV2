      ...
      <div className={`${styles.RecordBox}`}>
        ...
        {props.records.map((r, i) => (
          <div
            ...
            } ${styles.RecordSpan} ${r.type === 'BOX' && styles.RecordHits} ${(props.focus && props.focus.x === letters.indexOf(r.x) && props.focus.y === (r.y-1) && props.focus.owner === r.player?.nickname) && styles.FocusRecord} me-2 my-1 border p-1`}
